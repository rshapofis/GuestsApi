<html>
	...
	<body>
		...
		<li>telephone - номер телефона записываемого гостя(обязательный) </li>
		<li>email - почтовый адрес записываемого гостя</li>
		<li>country - страна записываемого гостя<br> что бы работала подстановка страны от номера телефона номер должен имет формат начинающийся с +</li>
		</p>
		...
		<li>new_telephone - новый номер телефона обновить данный параметр гостя</li>
		<li>email - почтовый адрес обновить данный параметр гостя</li>
		<li>country - страна обновить данный параметр гостя<br> что бы работала подстановка страны от номера телефона номер должен имет формат начинающийся с +</li>
		</p>
